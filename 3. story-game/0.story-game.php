...
<body>
    ...
    <div id="indexMain">
        <p>
            After your airplane crashed, you're left alone on an island.<br>
            There's a river to your right, and a desert to your left<br>
            In which direction are you heading?<br>
        </p>
